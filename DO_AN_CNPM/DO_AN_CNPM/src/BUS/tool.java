...
public class tool
{
    ...
    public void timkiem_theo_tu_trong_chuoi_ARRAY(String str, String[] ds, int n)
    {
        int lenth = str.length();
    ...
    public ArrayList<NCC> timkiem_theo_tu_trong_chuoi_LIST(String str, ArrayList<NCC> list)
    {
        int lenth = str.length();
