...
public class NhaCungCapDAO{
    ...
    public static ArrayList<NhaCungCapDTO> getList() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                nhacungcapDTO.setTenncc(rs.getString("ten"));
  ...
  public static int  Insert(NhaCungCapDTO nhacungcapDTO){
      try {
            Connection cons = DBConnect.getConnection();
            String sql = "INSERT INTO nhacungcap(mancc, ten, diachi, sodt) "
                    + "VALUES ( ?, ?, ?, ?)";
  ...
  public static int Update(NhaCungCapDTO nhacungcapDTO){
        try {
            Connection cons = DBConnect.getConnection();
            String sql="UPDATE nhacungcap SET ten=?,diachi=?,sodt=? WHERE mancc=?";
